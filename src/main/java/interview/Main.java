...
import interview.task1.ArrayTask;
import interview.task2.FileReader;
import interview.task2.TextAnalyzer;
...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        List<List<Integer>> listOfGtEProducts = task1.addProductsToList(array, 9000);
        System.out.println(listOfGtEProducts.toString());
